...
export function ScheduleCta() {
  return (
    <div className="relative isolate flex w-full flex-col items-center justify-between gap-8 overflow-hidden rounded-2xl bg-slate-900 p-8 text-white md:flex-row md:p-12 lg:p-16">
